...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Ryan Coyne"
  # s.authors            = { "Ryan Coyne" => "ryan@clearcodex.com" }
  # s.social_media_url   = "http://twitter.com/Ryan Coyne"
  ...
  s.source       = { :git => "http://EXAMPLE/TestFramework.git", :tag => "#{s.version}" }
